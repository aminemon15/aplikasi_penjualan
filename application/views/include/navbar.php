	...
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?php echo site_url(); ?>">
				<img alt="<?php echo config_item('web_title'); ?>" src="<?php echo config_item('img'); ?>logo_small.png">123
			</a>
		</div>
...
<!-- List Transkasi yang interkoneksi ke kasir -->
				<?php if($level == 'admin' OR $level == 'keuangan' OR $level == 'kasir') { ?>
				<li class="dropdown <?php if($controller == 'service') { echo 'active'; } ?>">
				 <?php if($controller == '') { echo "class='active'"; } ?><a href="<?php echo site_url('service'); ?>"><i class='fa fa-edit fa-fw'></i> Service </a>
				</li>
				<?php } ?>
<!-- tutup -->
...
<?php if($level == 'admin' OR $level == 'keuangan' OR $level == 'kasir') { ?>
				<li class="dropdown <?php if($controller == 'penjualan') { echo 'active'; } ?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="false" aria-expanded="false"><i class='fa fa-shopping-cart fa-fw'></i> Penjualan <span class="caret"></span></a>
					<ul class="dropdown-menu">
						<?php if($level !== 'keuangan'){ ?>
							<li class="dropdown <?php if($controller == 'penjualan') ?>">
							 <?php if($controller == '') { echo "class='active'"; } ?><a href="<?php echo site_url('penjualan'); ?>"></i> Penjualan </a>
							</li>
						<li><a href="<?php echo site_url('penjualan/history'); ?>">Rekap Penjualan</a></li>
				...
				<?php } ?>
<!-- List Barang UNIVERSAL -->
				<li class="dropdown <?php if($controller == 'barang') { echo 'active'; } ?>">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class='fa fa-cube fa-fw'></i> Pembelian <span class="caret"></span></a>
					<ul class="dropdown-menu">
...
<!-- Tutup -->
<!-- List Laporan Terkoneksi ke keuangan -->
				<?php if($level == 'admin' OR $level == 'keuangan') { ?>
				<li <?php if($controller == 'laporan') { echo "class='active'"; } ?>><a href="<?php echo site_url('laporan'); ?>"><i class='fa fa-book fa-fw'></i> Pembukuan</a></li>
				<?php } ?>
<!-- Tutup -->
<!-- List list user terkoneksi admin -->
				<?php if($level == 'admin') { ?>
